...
public class TaskFormView extends VerticalLayout {
    ...
    private void setupGridColumns(Binder<Task> gridBinder) {
        ...
        Grid.Column<Task> statutColumn = grid.addColumn(new ComponentRenderer<>(task -> {
                    ...
                    if (badgeVariant.equals("primary")){
                        badgeSpan.addClassName("badge-custom-en-cours");
                    }
                    return badgeSpan;
                })).setKey("statut")
                .setHeader("Statut")
        ...
        Grid.Column<Task> priorityColumn = grid.addColumn(new ComponentRenderer<>(task -> {
                    ...
                    Span priorityBadge = new Span(taskPriority.getDisplayName());
                    ...
                    if (variant.equals("primary")){
                        priorityBadge.addClassName("badge-custom-en-cours");
                    }
        ...
        Grid.Column<Task> actionsColumn = grid.addComponentColumn(task -> {
                    ...
                    editButton.addClassName("bouton-custom");
