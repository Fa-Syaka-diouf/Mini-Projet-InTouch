...
public class TaskFormView extends VerticalLayout {
    ...
    private void setupUI() {
        ...
        configureGrid();
        H3 title = new H3("Liste des Taches");
    ...
    private void showTaskDetails(Task task) {
        ...
        // Désactiver le bouton terminer si déjà terminé
        ...
        editButton.addClickListener(e -> {
            detailsDialog.close();
            // Ajouter la logique pour ouvrir le formulaire d'édition
            openForm(task);
        });
        ...
        // Layout des boutons avec groupement logique
    ...
    // Méthode helper pour créer un badge de statut coloré
    ...
    // Méthode helper pour créer des lignes de détail stylées avec icônes
